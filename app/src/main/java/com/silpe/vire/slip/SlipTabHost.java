...
public class SlipTabHost extends RelativeLayout implements View.OnClickListener {

    private int primaryColor;
    private int accentColor;
    private int textColor;
    private int iconColor;
    private List<SlipTab> tabs;
    ...
    public SlipTabHost(Context context) {
        this(context, null);
    }

    public SlipTabHost(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlipTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs != null) {
            ...
            accentColor = Color.parseColor("#00b0ff");
    ...
    public void addTab(SlipTab tab) {
    ...
    public SlipTab newTab() {
        return new SlipTab(this.getContext(),hasIcons);
    }
